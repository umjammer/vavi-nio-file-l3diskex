...
public class DiskBasicDirItemX1HU extends DiskBasicDirItem<DirectoryX1Hu> {
    ...
    public DiskBasicDirItemX1HU(DiskBasic basic, DiskImageSector sector, int secPos, byte[] data, int dataP) {
    ...
    public DiskBasicDirItemX1HU(DiskBasic basic, int num, DiskBasicGroupItem groupItem, DiskImageSector sector, int secPos,
