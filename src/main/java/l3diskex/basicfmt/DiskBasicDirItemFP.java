...
public class DiskBasicDirItemFP extends DiskBasicDirItemFAT8<DirectoryFp> {
    ...
    public static final int FILETYPE_FP_BASIC = 0x10;
    public static final int FILETYPE_FP_DATA = 0x04;
    public static final int FILETYPE_FP_MACHINE = 0x0d;
    public static final int FILETYPE_FP_ASCII = 0x20;
    public static final int FILETYPE_FP_RANDOM = 0x80;
    ...
    public String getFileAttrStr() {
        ...
        // Placeholder String that simulates concatenation and translation
        String attrStr = G_TYPE_NAME_1[p1];

        int p2 = getFileType2Pos();
        attrStr += " - ";
        attrStr += G_TYPE_NAME_2[p2];

        int t2 = getFileType2();
        if ((t2 & DATATYPE_MASK_FP_READ_ONLY) != 0) {
            attrStr += ", ";
            attrStr += G_TYPE_NAME_FP_2[TYPE_NAME_FP_READ_ONLY];
        }
        if ((t2 & DATATYPE_MASK_FP_READ_WRITE) != 0) {
            attrStr += ", ";
    ...
    @Override
    public boolean copyData(DirectoryFp val) {
