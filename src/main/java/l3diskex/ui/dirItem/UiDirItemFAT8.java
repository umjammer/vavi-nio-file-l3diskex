...
public class UiDirItemFAT8 extends UiDirItem {
    ...
    public void CreateControlsForAttrDialog(IntNameBox parent, int show_flags, String file_path, Object sizer, Object flags) {
        ...
        String[] types2 = new String[TYPE_NAME_2_RANDOM + 1];
        for (int i = 0; i <= TYPE_NAME_2_RANDOM; i++) {
            types2[i] = G_TYPE_NAME_2[i]; // Using direct string for translation
        }

        radType2 = new ButtonGroup(parent, ATTR_DIALOG_IDC_RADIO_TYPE2, "Data Type", types2); // Constructor simplified
        ...
        // parent.Bind(Event.RADIOBOX, parent::OnChangeType1, ATTR_DIALOG_IDC_RADIO_TYPE1);
    }
